...
# async_client is injected by pytest. Pytest looks up the tree looking
# for a fixture called async_client
@pytest.fixture()
...
async def test_get_all_posts_sorting(
    async_client: AsyncClient, logged_in_token: str, sorting, expected
):
...
@pytest.mark.anyio
async def test_get_all_posts_sorting_worng(async_client: AsyncClient):
